...
// watching.
func WebhookHandler(signingSecret string, svc *application.Service) (http.Handler, error) {
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case "user.created", "user.updated":
			...
			if _, err := svc.Provision(r.Context(), u.ID, clerk.IdentityFromUser(&u)); err != nil {
